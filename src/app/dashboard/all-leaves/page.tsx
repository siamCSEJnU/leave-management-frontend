...
export default function AllLeaves() {
  ...
  useEffect(() => {
    api
      ...
      .catch((err) => {
        toast.error("Failed to load all leaves");
        setLoading(false);
      });
  }, []);

  if (loading)
    return <div className="p-10 text-center">Loading all leaves...</div>;

  return (
    <div className="p-6">
      <h1 className="text-3xl font-bold mb-8">All Leaves</h1>
              ...
              <div className="flex justify-between items-start">
                <div>
                  <p className="text-xl font-semibold">
                    ...
                    {leave.employee.email}) - {leave.leave_type.toUpperCase()}{" "}
                    Leave
                  </p>
